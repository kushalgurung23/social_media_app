...
class ParentRegisterProvider extends ChangeNotifier {
  GlobalKey<FormState> parentRegisterKey = GlobalKey<FormState>();
  ...
  Future<void> registerParent({required BuildContext context}) async {
    try {
