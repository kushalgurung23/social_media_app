...
Widget customBottomModalBody(
        {required BuildContext modalContext,
        required List<String> listItems,
        required String? value,
        required void Function(BuildContext) onClose,
      ...
      child: Column(mainAxisSize: MainAxisSize.min, children: [
        Row(
          ...
          children: [
            ...
            IconButton(
                onPressed: () => onClose(modalContext),
            ...
            child: Row(
              ...
              children: [
                SizedBox(
                  ...
                  child: Text('${AppLocalizations.of(modalContext).category}:',
                      style: TextStyle(
                ...
                Expanded(
                  child: Container(
                    ...
                    child: CustomDropdownButton(
                      ...
                      hintText:
                          AppLocalizations.of(modalContext).selectACategory,
                      value: value,
                      listItems: listItems,
                      onChanged: (value) => onChanged(modalContext, value),
                    ),
                  ),
                ),
              ],
        ...
        Padding(
            padding: EdgeInsets.symmetric(vertical: SizeConfig.defaultSize * 4),
            child: Row(
              children: [
                Expanded(
                ...
                Expanded(
                  child: RectangularButton(
                    ...
                    text:
                        AppLocalizations.of(modalContext).filter.toUpperCase(),
                    textColor: Colors.white,
