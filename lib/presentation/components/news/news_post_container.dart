...
class _NewsPostContainerState extends State<NewsPostContainer>
  ...
  Widget build(BuildContext context) {
    super.build(context);
    final newsProvider = Provider.of<NewsAdProvider>(context, listen: false);
    return Padding(
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  PostTopBody(
                    newsCommentTextEditingController: newsTextEditingController,
                    ...
                    saveOnPress: widget.onSave,
                    isLike: widget.newsPost.isLiked == 1 ? true : false,
                    likeOnPress: widget.onLike,
                  ...
                  Padding(
                    ...
                    child: RoundedTextFormField(
                        ...
                        suffixOnPress: () =>
                            widget.onComment(newsTextEditingController),
