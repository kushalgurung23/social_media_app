...
class BookmarkPaperShareContainer extends StatefulWidget {
  final PaperShare paperShare;
  final String? paperShareSaveId;

  const BookmarkPaperShareContainer(
      {Key? key, required this.paperShare, required this.paperShareSaveId})
      : super(key: key);

  @override
  State<BookmarkPaperShareContainer> createState() =>
      _BookmarkPaperShareContainerState();
}

class _BookmarkPaperShareContainerState
    extends State<BookmarkPaperShareContainer>
  ...
  Widget build(BuildContext context) {
    ...
    return Consumer<PaperShareProvider>(builder: (context, data, child) {
      return StreamBuilder<BookmarkPaperShare>(
              ...
              default:
                if (snapshot.hasError) {
                  ...
                  BookmarkPaperShareData? bookmarkPaperShareData =
                      snapshot.data!.data!.firstWhereOrNull((element) =>
                          element != null &&
                          ...
                          element.attributes!.paperShare!.data!.id.toString() ==
                              widget.paperShare.id.toString());
                  PaperShare? paperData;
                  if (bookmarkPaperShareData != null &&
                      bookmarkPaperShareData.attributes != null &&
                      bookmarkPaperShareData.attributes!.paperShare != null &&
                      bookmarkPaperShareData.attributes!.paperShare!.data !=
                          null) {
                    paperData =
                        bookmarkPaperShareData.attributes!.paperShare!.data;
                  } else {
                    ...
                    return GestureDetector(
                      onTap: () {
                        data.navigateToPaperDescription(
                            ...
                            source: PaperShareSourceType.bookmark);
                      },
                      child: Container(
                                            ...
                                            data.togglePaperShareSave(
                                                savedPaperShareId: data
                                                    ...
                                                    ? widget.paperShareSaveId
                                                        .toString()
                                                    : null,
                                                source: PaperShareSourceType
                                                    .bookmark,
                                                context: context,
                                                paperShareId:
                                                    paperData.id.toString());
                                          },
