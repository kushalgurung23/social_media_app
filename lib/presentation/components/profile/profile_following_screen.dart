...
class ProfileFollowingScreen extends StatefulWidget {
  // Additional profile are the remaining profile which are not displayed in following container of user profile tab.
  final bool additionalProfile;
              ...
              body: Padding(
                ...
                child: followingList!.isEmpty
                    ...
                    : ListView.builder(
                        ...
                        itemCount: widget.additionalProfile
                            ? followingList.length - 7
                            : followingList.length,
                        itemBuilder: (context, index) {
                          final userFollow = widget.additionalProfile == false
                              ? followingList[index]!
                              : followingList[index + 7]!;
                          final followingUser =
