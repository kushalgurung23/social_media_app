...
class StudentRegistrationScreen extends StatelessWidget {
  static const String id = '/student_register_screen';

  const StudentRegistrationScreen({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return Consumer<StudentRegisterProvider>(
                    ...
                    children: [
                      Flexible(
                        child: SingleChildScrollView(
                          ...
                          child: Form(
                            key: data.studentRegisterFormKey,
                            child: Column(
